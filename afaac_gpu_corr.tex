...
\begin{figure*}[tbh]
 \center{
        {\includegraphics[width=0.8\textwidth] {sb0_acm.png}}
        {\includegraphics[width=0.8\textwidth] {sb1_acm.png}}
        {\includegraphics[width=0.8\textwidth] {sb2_acm.png}}
...
\begin{figure*}[tbh]
 \center{
        {\includegraphics[width=0.8\textwidth] {sb0_04Jun14.png}}
