...
\section{Uncalibrated 6 station CPU and GPU images: LBA\_OUTER}
%% \FloatBarrier
\begin{figure*}
\center{
 \includegraphics [width=0.45\columnwidth]{Figs/uncal_cpu_ch32_6station.png}
 \includegraphics [width=0.45\columnwidth]{Figs/uncal_cpu_ch32_6station_nodelay.png}
 \includegraphics [width=0.45\columnwidth]{Figs/gpucorr_uncalmap.png}
...
\center{
 ...
 \caption {Uncalibrated 3station images, GPU correlated. 30ch/1sec avg (left col), 1ch/1sec avg (right col)} 
}
\end{figure*}
...
\begin{figure*}[h]
\center{
 \includegraphics [width=0.9\columnwidth]{Figs/uncal_cpu_ch31-32_cs3_5_7_del.png}
 \includegraphics [width=0.9\columnwidth]{Figs/uncal_cpu_ch31-32_cs3_5_7_nodel.png}
